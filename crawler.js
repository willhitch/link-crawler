/* =====================================================================================
 Blog and Guide Product Recommendations
 ======================================================================================*/
	...
	switch (links[i].href) {
		...
		case "https://uniquecampingmarine.com/products/rv-digest-it-holding-tank-treatment":
			if (rvDigestItLiquid <= 0) {
				text = `<a href="${links[i].href}" alt="RV Digest-it Holding Tank Treatment Liquid. Unique Camping + Marine">RV Digest-It | Liquid</a>`;
				linkArr.push(text);
				rvDigestItLiquid++;
		...
		case "https://uniquecampingmarine.com/products/rv-digest-it-drop-in-pods":
			if (rvDigestItDropIn <= 0) {
				text = `<a href="${links[i].href}" alt="RV Digest-it Holding Tank Treatment Drop-In. Unique Camping + Marine">RV Digest-It | Drop-In</a>`;
				linkArr.push(text);
				rvDigestItDropIn++;
		...
		case "https://uniquecampingmarine.com/products/rv-digest-it-powder-treatment":
			if (rvDigestItPowder <= 0) {
				text = `<a href="${links[i].href}" alt="RV Digest-it Holding Tank Treatment Powder. Unique Camping + Marine">RV Digest-It | Powder</a>`;
				linkArr.push(text);
				rvDigestItPowder++;
		...
		case "https://uniquecampingmarine.com/products/rv-toilet-bowl-cleaner-holding-tank-enhancer":
			if (rvToiletCleaner <= 0) {
				text = `<a href="${links[i].href}" alt="RV Toilet Cleaner + Holding Tank Enhancer. Unique Camping + Marine">RV Toilet Cleaner + Holding Tank Enhancer</a>`;
				linkArr.push(text);
				rvToiletCleaner++;
		...
		case "https://uniquecampingmarine.com/products/rv-tank-cleaner":
			if (tankCleaner <= 0) {
				text = `<a href="${links[i].href}" alt="Holding Tank Cleaner. Unique Camping + Marine">Holding Tank Cleaner</a>`;
				linkArr.push(text);
				tankCleaner++;
		...
		case "https://uniquecampingmarine.com/products/sensor-cleaner":
			if (sensorCleaner <= 0) {
				text = `<a href="${links[i].href}" alt="Sensor Cleaner for Black Tanks. Unique Camping + Marine">Sensor Cleaner</a>`;
				linkArr.push(text);
				sensorCleaner++;
		...
		case "https://uniquecampingmarine.com/products/tank-odor-eliminator-drop-in-pods":
			if (tankOdor <= 0) {
				text = `<a href="${links[i].href}" alt="Tank Odor Eliminator. Unique Camping + Marine">Tank Odor Eliminator</a>`;
				linkArr.push(text);
				tankOdor++;
			} else if (tankOdor) {
				break;
		...
		case "https://uniquecampingmarine.com/products/marine-digest-it":
			if (marineDigestIt <= 0) {
				text = `<a href="${links[i].href}" alt="Marine Digest-It. Unique Camping + Marine">Marine Digest-It</a>`;
				linkArr.push(text);
				marineDigestIt++;
		...
		case "https://uniquecampingmarine.com/products/the-unique-method-product-pack":
			if (uniqueMethod <= 0) {
				text = `<a href="${links[i].href}" alt="The Unique Method Product Pack. Unique Camping + Marine">Unique Method Product Pack</a>`;
				linkArr.push(text);
				uniqueMethod++;
		...
		case "https://uniquecampingmarine.com/products/hot-weather-camper-pack":
			if (hotWeather <= 0) {
				text = `<a href="${links[i].href}" alt="Hot Weather Camper Pack. Unique Camping + Marine">Hot Weather Camper Pack</a>`;
				linkArr.push(text);
				hotWeather++;
		...
		case "https://uniquecampingmarine.com/products/dry-camper-pack":
			if (dryCamper <= 0) {
				text = `<a href="${links[i].href}" alt="Dry Camper Pack. Unique Camping + Marine">Dry Camper Pack</a>`;
				linkArr.push(text);
				dryCamper++;
			} else if (dryCamper > 0) {
				break;
		...
		case "https://uniquecampingmarine.com/products/full-hookup-camping-pack":
			if (fullHookup <= 0) {
				text = `<a href="${links[i].href}" alt="Full Hookup Camper Pack. Unique Camping + Marine">Full Hookup Camper Pack</a>`;
				linkArr.push(text);
				fullHookup++;
		...
		case "https://uniquecampingmarine.com/products/full-timer-pack":
			if (fullTimer <= 0) {
				text = `<a href="${links[i].href}" alt="Full Timer Camper Pack. Unique Camping + Marine">Full Timer Camper Pack</a>`;
				linkArr.push(text);
				fullTimer++;
			} else if (fullTimer > 0) {
				break;
		...
		case "https://uniquecampingmarine.com/products/tank-maintenance-pack":
			if (biannualTank <= 0) {
				text = `<a href="${links[i].href}" alt="Biannual Tank Maintenance Pack. Unique Camping + Marine">Biannual Tank Maintenance Pack</a>`;
				linkArr.push(text);
				biannualTank++;
